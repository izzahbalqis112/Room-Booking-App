...
class SelectedBookingIDDetailsPage extends StatefulWidget {
  final String bookingId;

  SelectedBookingIDDetailsPage({required this.bookingId});

  @override
  _SelectedBookingIDDetailsPageState createState() =>
      _SelectedBookingIDDetailsPageState();
}

class _SelectedBookingIDDetailsPageState extends State<SelectedBookingIDDetailsPage> {
